...
public class StickyTrapModel<T extends Entity> extends EntityModel<T> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(MonsterHunterVillager.id("modelsticky_trap"), "main");

    private final ModelPart bone;

    public StickyTrapModel(ModelPart root) {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition bone = partdefinition.addOrReplaceChild(
            ...
            CubeListBuilder.create()
                .texOffs(0, 16)
                .addBox(-4.0F, -3.04F, -4.0F, 8.0F, 3.0F, 8.0F, new CubeDeformation(0.0F))
                .texOffs(0, 0)
                .addBox(-8.0F, -0.05F, -8.0F, 16.0F, 0.0F, 16.0F, new CubeDeformation(0.0F)),
